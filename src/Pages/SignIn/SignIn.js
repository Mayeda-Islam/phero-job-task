...
const SignIn = () => {
  ...
  const { signIn, signInWithGoogle } = useContext(MyContext);
  const {
    register,
    handleSubmit,
    watch,
    ...
    <section class="h-screen">
      <div class="px-6 h-full text-gray-800">
        <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
          <div class="grow-0 shrink-1 md:shrink-0 basis-auto  lg:w-1/3 md:w-9/12 mb-12 md:mb-0">
            <img
          ...
          <div class="xl:ml-20  lg:w-1/4 md:w-8/12 mb-12 md:mb-0">
